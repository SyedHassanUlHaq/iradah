...
export const Hero = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[100svh] flex items-end md:items-center overflow-hidden bg-background">
      ...
      <div
        className="relative z-10 w-full md:w-[42%] px-5 md:px-8 lg:px-10 xl:px-12 pb-20 md:pb-0 pt-[134px] transition-opacity duration-100 will-change-[opacity,transform]"
        style={{
